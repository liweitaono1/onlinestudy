...
class StartXHandler(object):
    ...
    def changelist(self, request, *args, **kwargs):
        ...
        return render(request, self.list_template or 'startX/list.html', {
            'data_list': data_list,
    ...
    def extra_url(self):
        '''预留的重新自定义url钩子函数,主要是在原有基础上增加url,对应的视图也需要自定义,extra_url原则上不能和get_url同时使用'''
        return []
