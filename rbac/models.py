...
class Permission(models.Model):
    ...
    menu = models.ForeignKey(to='Menu', on_delete='cascade', verbose_name='所属菜单', null=True, blank=True,
    ...
    pid = models.ForeignKey(verbose_name='关联的权限', to='Permission', null=True, blank=True, related_name='parents',
                            help_text='对于非菜单权限需要选择一个可以成为菜单的权限，用户做默认展开和选中菜单', on_delete='cascade')
